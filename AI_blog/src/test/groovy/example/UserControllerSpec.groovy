...
class UserControllerSpec extends Specification implements ControllerUnitTest<CustomerController>, DomainUnitTest<User> {
    ...
    void "Test the save action with an invalid instance"() {
        given:
        controller.customerService = Mock(CustomerService) {
            1 * save(_ as User) >> { User customer ->
    ...
    void "Test the show action with a valid id"() {
        ...
        model.customer instanceof User
    }
